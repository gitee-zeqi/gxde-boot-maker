...
<context>
    ...
    <message>
        ...
        <translation>Ελάττωμα Αποσυμπίεσης Εικόνας: Παρακαλώ ελέγξτε το md5 checksum της εικόνας και βεβαιωθείτε ότι η εικόνα είναι πλήρης</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Deepin Boot Maker είναι ένα απλό εργαλείο για να γράψετε αρχείο εικόνας συστήματος σε CD/DVD, USB stick και άλλα μέσα εγκατάστασης.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Το αρχείο καταγραφής σφαλμάτων θα ανεβάσει αυτόματα μαζί με τις αναφορές. Δεν μπορούμε να βελτιωθούμε χωρίς τις αναφορές και την υποστήριξή σας.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Μορφοποίηση δίσκου μπορεί να αυξήσει τον ποσοστό επιτυχίας δημιουργίας</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Οι δεδομένα του δίσκου θα διαγραφούν πλήρως με τη μορφοποίηση, παρακαλώ επιβεβαιώστε και συνεχίστε</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Όλα τα δεδομένα θα χαθούν κατά τη διαμόρφωση, παρακαλούμε ετοιμάστε αντίγραφα ασφαλείας και ύστερα επιλέξτε ΟΚ.</translation>
    </message>
    <message>
